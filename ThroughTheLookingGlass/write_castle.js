...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'assets', true, true);
   ...
   loadPackage({"files": [{"filename": "/assets/dottedlines.f", "start": 0, "end": 3824, "audio": 0}, {"filename": "/assets/dottedlines.vs", "start": 3824, "end": 4261, "audio": 0}, {"filename": "/assets/draw_to_screen.vs", "start": 4261, "end": 4488, "audio": 0}, {"filename": "/assets/FinalFloor.json", "start": 4488, "end": 8224, "audio": 0}, {"filename": "/assets/FinalFloor.png", "start": 8224, "end": 24163, "audio": 0}, {"filename": "/assets/FinalPiece.json", "start": 24163, "end": 30535, "audio": 0}, {"filename": "/assets/FinalPiece.png", "start": 30535, "end": 36270, "audio": 0}, {"filename": "/assets/FloorAtlas.png", "start": 36270, "end": 36915, "audio": 0}, {"filename": "/assets/FloorAtlasOld.png", "start": 36915, "end": 37561, "audio": 0}, {"filename": "/assets/fullsprite.vs", "start": 37561, "end": 38301, "audio": 0}, {"filename": "/assets/gl_text.fs", "start": 38301, "end": 38546, "audio": 0}, {"filename": "/assets/gl_text.vs", "start": 38546, "end": 38770, "audio": 0}, {"filename": "/assets/movesprite.f", "start": 38770, "end": 39743, "audio": 0}, {"filename": "/assets/movesprite.vs", "start": 39743, "end": 41557, "audio": 0}, {"filename": "/assets/PieceAtlas.png", "start": 41557, "end": 42125, "audio": 0}, {"filename": "/assets/pieces.json", "start": 42125, "end": 43067, "audio": 0}, {"filename": "/assets/pieces.png", "start": 43067, "end": 43902, "audio": 0}, {"filename": "/assets/sprite.f", "start": 43902, "end": 44057, "audio": 0}, {"filename": "/assets/sprite.vs", "start": 44057, "end": 44703, "audio": 0}, {"filename": "/assets/string.f", "start": 44703, "end": 45070, "audio": 0}, {"filename": "/assets/string.vs", "start": 45070, "end": 45688, "audio": 0}, {"filename": "/assets/temp.json", "start": 45688, "end": 47027, "audio": 0}, {"filename": "/assets/text.vs", "start": 47027, "end": 47548, "audio": 0}], "remote_package_size": 47548, "package_uuid": "7a8a2371-d431-4250-86ca-4a991c43ffd4"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 189680,
    DYNAMIC_BASE = 5432560,
    DYNAMICTOP_PTR = 189520;
...
var wasmBinaryFile = 'write_castle.wasm';
...
var ASM_CONSTS = {
  9802: function($0) {var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL);},  
 45596: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 47075: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 48064: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 48157: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 49382: function() {return screen.width;},  
 49409: function() {return screen.height;},  
 49437: function() {return window.innerWidth;},  
 49469: function() {return window.innerHeight;},  
 49547: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 49681: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 49847: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 50073: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 50626: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
