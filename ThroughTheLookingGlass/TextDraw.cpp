...
float get_horizontal_space_consumed_by_text(glm::vec3 start_position, glm::vec2 scale, const char* c_string, TextWrite* info)
{
...
LineBounds get_linebounds_space_consumed_by_text(glm::vec3 start_position, glm::vec2 scale, const char* c_string, TextWrite* info)
{
	//TODO: get info.current_number_drawn to replace the other number we were using.
	glm::vec3 next_position = start_position;
	LineBounds result;
