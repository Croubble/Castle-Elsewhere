...
TextScene* level_popup_customtime(std::string level_name, Memory* text_memory, float current_time, float display_time)
{
return build_text_scene(level_name, SCENE_TYPE::ST_PLAY_LEVEL, text_memory, current_time, display_time);
}
